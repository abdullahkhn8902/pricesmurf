...
export const HeroHighlight = ({
    ...
    return (
        <div
            className={cn(
                "group relative flex w-full items-center justify-center  dark:bg-black",
                containerClassName,
            )}
...
export const Highlight = ({
    ...
    return (
        <motion.span
            ...
            className={cn(
                `relative inline-block rounded-lg bg-gradient-to-r from-indigo-900 to-purple-900 px-1 pb-1 dark:from-indigo-900 dark:to-purple-900`,
                className,
            )}
        >
            {children}
