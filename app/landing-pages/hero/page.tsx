...
export default function BackgroundLinesDemo() { // Added default export
    return (
        <>
            <AuroraBackground>
                <HeroHighlight>
                    <motion.h1
                        ...
                        className="text-2xl px-4 md:text-4xl lg:text-5xl font-bold text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto mt-[10rem]"
                    >
                        ...
                        <p className="max-w-xl mx-auto text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-center font-light m-5">
